        ...
        <div className={styles["navbar__actions"]}>
          ...
          {isAuthed ? (
              ...
              <AnimatePresence>
                {isUserMenuOpen && (
                  ...
                  >
                    <Link
                      href="/settings"
                      className={styles["navbar__user-item"]}
                    >
                      <FiSettings size={16} />
                      Settings
                    </Link>
            ...
            <div className={styles["navbar__auth"]}>
              <Link href="/login" className={styles["navbar__auth-btn"]}>
                Login
              </Link>
              <Link
                href="/signup"
                className={`${styles["navbar__auth-btn"]} ${styles["navbar__auth-primary"]}`}
              >
                Sign up
              </Link>
            </div>
